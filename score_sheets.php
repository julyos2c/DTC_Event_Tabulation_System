        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
             ...
             <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="40" height="40" />&nbsp; <font size="3">Danao Technological College</font></a> 
...
<header class="jumbotrontabulator subhead" id="overview">
  ...
  <div class="container">
    <h1>Score Sheets</h1>
  <p class="lead">Event Management System - Tabulator's Panel</p>
  </div>
</header>       
<?php } ?>
