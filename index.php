...
<!-- <header class="jumbotron subhead" id="overview">
  <div class="container ">
    ...
    <h1>Event Tabulation Management System</h1>
  </div>
</header> -->
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="Login">About  </h4>
                    </div>
                    ...
                    <td><strong> Julius Jess Estose</strong> - Instructor and Web Developer</td>
                    </tr>
      
                    <tr>
                    <td align="right">Email:</td>
                    <td><strong>estosejuliusjess@gmail.com</strong></td>
                    </tr>
